...
public class SchemaTranslator {
	 ...
	 * @throws IOException
	 */
	public SchemaTranslator translate(FileOutputStream outputStream)
			throws IOException {
	 ...
	 * @throws IOException
	 */
	private void write(FileOutputStream outputStream, String[] lines,
	...
	public static void main(String[] args) throws IOException {
		...
		Class<?>[] entityClasses = { Buyer.class, Seller.class, Product.class,
				Login.class, Bid.class };
